...
let annonceCoupsRestants = document.querySelector(".annonce-cps-restant")
...
//let pointJ1 = localStorage.getItem("pointj1");
...
if (result[0] + result[3] + result[6] === 3){
    ...
    win = true;
    //localStorage.setItem("pointj1", 0)
    //pointJ1 = pointJ1 + 1; point1 = pointJ1;
    ...
    annonce.innerText = "Le joueur 2 à gagné la manche !!!";
    win = true;
...
newGame.addEventListener("click", function(){
    ...
    cases[i].style.color = "white";
    cases[i].style.background = "none"
...
if (pointMax === point1.innerText){
    ...
    annonce.innerText = "Félicitation, joueur 2 à gagné !";
    newGame.style.display = "none";
    mainMenu.style.display = "block";
}
